        ...
        // <div className='footer-container'>
            <footer className='flex flex-col p-3 mt-6 '>
                <div className='overflow-hidden flex gap-5 mt-3'>
                    ...
                    <Link title='Email' to='mailto:smackeem@outlook.com' className='links z-depth-5 ' target="_blank" rel="noreferrer">
                    <img className='img' src={EmailIcon}/>
                    </Link>
                </div>
                <div className='m-5'>
                    <a href={ResumePDF} download='Ackeem-Smith-Resume' target='_blank' rel='noreferrer'>
                        <button className='teal accent-4 z-depth-5  hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center'>
